...
// * Use the {@link Games_Kids_fragment#newInstance} factory method to
// * create an instance of this fragment.
// */
public class Games_Kids_fragment extends Fragment {
...
//     * @return A new instance of fragment Games_Kids_fragment.
//     */
//    // TODO: Rename and change types and number of parameters
//    public static Games_Kids_fragment newInstance(String param1, String param2) {
//        Games_Kids_fragment fragment = new Games_Kids_fragment();
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_games__kids_fragment, container, false);

        recyclerView = view.findViewById(R.id.games_kids_recyclerview);
        loadingView = view.findViewById(R.id.loading_animation_Game__Kids);
        loadingViewBackground = view.findViewById(R.id.loading_animation_Background_Game__Kids);
        ...
        data_from_database.Main_rv_Data(Bottom_tab_name, top_tab_name, new MainLayout_interface() {
            ...
            public void onDataError(DatabaseError error) {
                Log.d("games kids", "onDataError: "+error);
            }
        });

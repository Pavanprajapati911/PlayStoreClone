...
// * Use the {@link Books_audiobooks_frag#newInstance} factory method to
// * create an instance of this fragment.
// */
public class Books_audiobooks_frag extends Fragment {
...
//     * @return A new instance of fragment Books_audiobooks_frag.
//     */
//    // TODO: Rename and change types and number of parameters
//    public static Books_audiobooks_frag newInstance(String param1, String param2) {
//        Books_audiobooks_frag fragment = new Books_audiobooks_frag();
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_books_audiobooks_frag, container, false);
        recyclerView = view.findViewById(R.id.books_audiobooks_reyclerview);
        loadingView = view.findViewById(R.id.loading_animation_Books__audiobooks);
        loadingViewBackground = view.findViewById(R.id.loading_animation_Background_Books__audiobooks);

        Bottom_tab_name="Books Tab";
        top_tab_name = "Audiobooks Tab";
...
//        recyclerView.setAdapter(new Parent_rv_adapter(All_Recyclerview_layout_data.Books_Tab_data(TAB_NAME),
//                getContext(),
